export const studentSupportItems = [
  {
    id: "ss-1",
    icon: "/assets/icons/student-support/counseling-icon.svg",
    title: "Counseling",
    description:
  ...
  {
    id: "ss-2",
    icon: "/assets/icons/student-support/learning-support-icon.svg",
  ...
  {
    id: "ss-3",
    icon: "/assets/icons/student-support/parent-teacher-collaboration-icon.svg",
