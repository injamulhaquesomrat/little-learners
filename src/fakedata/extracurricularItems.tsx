export const extracurricularItems = [
  {
    id: "e-1",
    icon: "/public/assets/icons/extracurricular/sports-and-atheletics-icon.svg",
  ...
  {
    id: "e-2",
    icon: "/public/assets/icons/extracurricular/art-and-creativity-icon.svg",
  ...
  {
    id: "e-3",
    icon: "/public/assets/icons/extracurricular/music-icon.svg",
  ...
  {
    id: "e-4",
    icon: "/public/assets/icons/extracurricular/language-clubs-icon.svg",
  ...
  {
    id: "e-5",
    icon: "/public/assets/icons/extracurricular/science-club-icon.svg",
    title: "Science Club",
    description:
  ...
  {
    id: "e6",
    icon: "/public/assets/icons/extracurricular/cooking-and-culinary-arts-icon.svg",
