  ...
  return (
    <div className="-mt-[90px] md:-mt-[100px] xl:-mt-[125px] pt-20 xl:pt-30 3xl:pt-[150px]">
      ...
      <Card className="p-[30px] xl:p-10 3xl:p-[50px] pt-30 xl:pt-40 3xl:pt-40 text-center md:text-left bg-white gap-5 xl:gap-[30px]">
        <CardHeader className="p-0 text-text-primary flex flex-col xs:flex-row-reverse justify-between items-center gap-5">
          ...
          {/* start::card title */}
          <CardTitle className="text-[28px] lg:text-3xl xl:text-[34px] 3xl:text-[40px] font-raleway font-bold text-text-primary leading-[1.5]">
            {item?.type}
          </CardTitle>
          {/* end::card title */}
        </CardHeader>

        <CardDescription className="p-0 text-text-light text-lg xl:text-xl 3xl:text-[22px] font-medium">
          {item?.description}
        </CardDescription>
      </Card>
