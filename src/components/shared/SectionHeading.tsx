...
const SectionHeading = ({
  ...
  return (
    <div className="flex flex-col items-center text-center gap-2.5 md:gap-3 lg:gap-3.5 3xl:gap-[19px] pb-[50px] xl:pb-20 3xl:pb-[100px]">
      <Badge
        variant={"neutral"}
        className="text-text-muted px-3.5 py-2 3xl:px-5 3xl:py-2.5 bg-white text-sm xl:text-base 3xl:text-lg"
      >
        {badgeText}
      </Badge>
      ...
      <p className="text-text-muted font-medium leading-[1.5] md:w-[700px] xl:w-[880px] 3xl:w-[992px] 3xl:text-xl">
        {subHeading}
      </p>
    </div>
  );
