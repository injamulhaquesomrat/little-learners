  ...
  return (
    ...
    >
      <CardHeader className="flex items-center justify-between p-0">
        <CardTitle className="text-[30px] xl:text-[38px] 3xl:text-5xl text-text-primary font-raleway font-bold leading-[1.3]">
          {item?.title}
        </CardTitle>
        <img
      ...
      <CardContent className="p-0 text-text-muted leading-[1.5] 3xl:text-xl">
        {item?.description}
      </CardContent>
    </Card>
  );
